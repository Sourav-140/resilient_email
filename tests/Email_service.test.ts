...
import { IEmailProvider } from '../src/Mock_email_providers';

class MockSuccessProvider implements IEmailProvider {
    async sendEmail(to: string, subject: string, body: string): Promise<boolean> {
        return true;
    }
}

class MockFailureProvider implements IEmailProvider {
    async sendEmail(to: string, subject: string, body: string): Promise<boolean> {
        return false;
    }
}
